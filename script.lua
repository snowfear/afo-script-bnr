	...
	function repeating(State)
		if State == "On" then
			...
			while valid == false do
				wait(0.1)
				game:GetService("Players").LocalPlayer.Character:WaitForChild("Main")
				...
				game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(666.867065, 1896.17151, -2661.4209) -- Muscular's CFrame: 1009.13379, 1896.10803, 2094.89575
			end                                                                                                              -- Awakened Tomura's CFrame: 1093.62415, 2010.55847, -1662.81689
		else																												 -- AFO's CFrame: 666.867065, 1896.17151, -2661.4209
